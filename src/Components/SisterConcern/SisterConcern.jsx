        ...
        >
          <div className="grid grid-cols-3 gap-10">
            <Link to={`/servicedetails/${id}`}>
              ...
              <div className="w-96 service-card p-8 shadow-md bg-base-100">
                <div className="logo-container w-16 h-16 border-[1px] border-[#ff4900] rounded-md mb-4 bg-[#ffffff] flex justify-center items-center">
